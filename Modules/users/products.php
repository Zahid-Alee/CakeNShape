    ...
    if (!empty($cakes)) {
      foreach ($cakes as $cake) {
        ...
        <div class="card">
          ...
          <button class="add-to-cart" onClick="addToCart('<?php echo $cake['CakeID'] ?>', '<?php echo $cake['CakeName'] ?>', '<?php echo $cake['Price'] ?>')">Add to Cart</button>
...
<script>
    ...
    const addToCart = (CakeID, CakeName, Price) => {
