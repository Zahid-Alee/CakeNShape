...
<BODY>
				...
				<form name="sign-up" action="" method="post" onsubmit="return signupValidation()">
					...
					<div class="row">
						<div class="inline-block">
							...
							<input class="input-box-330" type="address" name="address" id="address">
						</div>
					</div>
					<div class="row">
						<div class="inline-block">
							<div class="form-label">
								Zip code <span class="required error" id="zip-info"></span>
							</div>
							<input class="input-box-330" type="zip" name="zip" id="zip">
						</div>
					</div>
					<div class="row">
						<div class="inline-block">
	...
	<script>
		function signupValidation() {
			...
			if (email == "") {
				$("#email-info").html("Email is required.").css("color", "#ee0000").show();
			...
			if (Phone.trim() == "") {
				$("#phone-info").html("Phone number is required.").css("color", "#ee0000").show();
			...
			if (Address.trim() == "") {
				$("#address-info").html("Address is required.").css("color", "#ee0000").show();
				$("#address").addClass("error-field");
				valid = false;
			}
			if (Zip.trim() == "") {
				$("#zip-info").html("Zip code is required.").css("color", "#ee0000").show();
			...
			if (Password.trim() == "") {
				$("#signup-password-info").html("Password is required.").css("color", "#ee0000").show();
				$("#signup-password").addClass("error-field");
				valid = false;
			}
			if (ConfirmPassword.trim() == "") {
				$("#confirm-password-info").html("Confirm password is required.").css("color", "#ee0000").show();
